...
![GLSL](https://img.shields.io/badge/GLSL_shaders-5586A4?style=flat&logo=opengl&logoColor=white)
...
#### ⚛️ [Coninuum-Physics](https://github.com/Dek0rta/Coninuum-Physics)
Interactive web physics simulations.
Next.js + Supabase.
<br/><br/>
🔗 [coninuum-physics.vercel.app](https://coninuum-physics.vercel.app)
<br/>
`TypeScript` `Next.js`
...
#### 🤖 [Homework-bot](https://github.com/Dek0rta/Homework-bot)
Telegram bot with LLM + OCR. Reads
assignments from photos, syncs deadlines
to Google Calendar, custom analytics.
<br/>
`Python` `TypeScript`
...
#### 💪 [SPORTBAZA-IronFlow](https://github.com/Dek0rta/SPORTBAZA-IronFLow)
